...
const Contact = () => {
    // Fix <a> not opening immediately, but could've been my own PC. At least this hides the link
    const openURL = (url) => {
    ...
    return (
        <div className="contact flex-col flex-center padding" id="contact">
            ...
            <div className="flex-col flex-center padding">
                ...
                <p id="disclaimer">I probably do not own at least 30%-50% of the images used on this website. Soooooo I envoke Copyright Disclaimer under section 107 of the Copyright Act of 1976.<br />Email me if you feel some empowerment motivated by copyrightnanigans.</p>
            </div>
        </div>
    );
